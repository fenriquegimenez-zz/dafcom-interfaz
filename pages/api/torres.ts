...
import {
  ...
  getAll,
  getById,
} from '../../resources/torres/torre.service'
import {
  errorResponse,
  notAllowedResponse,
  successResponse,
} from '../../resources/torres/torre.response'
import { createTorreDto } from '../../resources/torres/torre.dto'
...
export default async function handler(
  ...
  const { id } = query
  if (method === 'POST') {
    const { error, isValid } = createTorreDto(payload)
