...
import {
  ...
  getAll,
  getById,
} from '../../resources/tecnicos/tecnico.service'
import {
  errorResponse,
  notAllowedResponse,
  successResponse,
} from '../../resources/tecnicos/tecnico.response'
import { createTecnicoDto } from '../../resources/tecnicos/tecnico.dto'
...
export default async function handler(
  ...
  const { id } = query
  if (method === 'POST') {
    const { error, isValid } = createTecnicoDto(payload)
